...
best_promt_dict = {
    "moxin": {
        "prompt_in":
        "shukezouma, negative space, , shuimobysim , <lora:shukezouma_v1_1:0.8>, portrait of a woman standing , willow branches, (masterpiece, best quality:1.2), traditional chinese ink painting, <lora:shuimobysimV3:0.7>, modelshoot style, peaceful, (smile), looking at viewer, wearing long hanfu, hanfu, song, willow tree in background, wuchangshuo,",
        "prompt_neg":
        ...
        "url":
        "https://civitai.com/images/214667?modelVersionId=14856&prioritizedUserIds=454257&period=AllTime&sort=Most+Reactions&limit=20"
    },
    "meina": {
        "prompt_in":
        "upper body, 1girl, white hair, ponytail, purple eyes, (ninja), short sword, medium breats ,scarf, wallpaper, magic circle background, light particles, blue fire,",
        "prompt_neg":
    ...
    "iren": {
        "prompt_in":
        "nikon RAW photo,8 k,Fujifilm XT3,masterpiece, best quality, realistic, photorealistic,ultra detailed,extremely detailed face, solo,1girl, dudou,sitting on a window seat in a pale pink dudou, looking out at the city lights at night with a dreamy expression on her face irene1, , <lora:irene_v70:1> <lora:dudou:.5>",
        "prompt_neg":
        "(worst quality:2), (low quality:2), (normal quality:2), lowres, normal quality, ((monochrome)), ((grayscale)), skin spots, acnes, skin blemishes, age spot, glans,extra fingers,fewer fingers,strange fingers,bad hand,",
...
def stable_diffusion_task(task_id,
                          prompt="",
                          width=512,
                          height=512,
                          steps=28,
    ...
    result = api.txt2img(
        ...
        save_images=True,
        alwayson_scripts={},
        sampler_index="DPM++ SDE Karras",  # deprecated: use sampler_name
    ...
    for image in result.images:
        ...
        oss_save_path = os.path.join("aigc_result/",
                                     str(task_id).zfill(8),
                                     str(save_id) + ".png")
            ...
            for task in tasks:
                ...
                if ret.status_code == 200:
                    print("task_id:", task_id,
                          " inferring succeed with results:", rets)
